...
import numpy as np
from muffin_arb.impl.int.math_utils import floor_div, compute_step, calc_tier_amounts_in, calc_tier_amounts_out, MIN_TICK, MAX_TICK


# GetTickData :: (tier_id, tick_index) -> (liquidity_delta, next_below, next_above)
GetTickData = Callable[[int, int], tuple[int, int, int]]
